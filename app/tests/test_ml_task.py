...
def test_create_task_invalid_format():
    ...
    """
    response = client.post("/ml_task/", files={"file": ("fake.txt", b"not an image", "text/plain")})
...
def test_get_task_wrong_password(monkeypatch):
    ...
    class FakeTask:
        ...
        def load_images(self): return Image.new("RGB", (224, 224))
        def delete_image_after_load(self): pass
